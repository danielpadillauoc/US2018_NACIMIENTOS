...
**Modelo4**
```{r}
model.logist4=glm(formula=PRIMER_EMBARAZO~EDAD_MADRE + ESTADO_CIVIL + RAZA_MADRE + EDUC_MADRE ,family=binomial)
...
p <- predict(model.logist4, type = "response",newdata = data.frame( EDAD_MADRE = 19,
...
p <- predict(model.logist4, type = "response", newdata = data.frame( EDAD_MADRE = 25,
                                        ESTADO_CIVIL = "Casada",
                                        RAZA_MADRE = "Caucasiana",
